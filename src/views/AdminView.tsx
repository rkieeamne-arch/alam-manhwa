...
import { Manhua, Chapter, ManhuaStatus, ScraperSource } from '../types';
...
export default function AdminView({
  ...
  const [activeTab, setActiveTab] = useState<'add-manhua' | 'add-chapter' | 'manage' | 'advanced' | 'sources'>('add-manhua');
