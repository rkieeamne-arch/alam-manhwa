            ...
            <div className="space-y-4 pt-4 border-t border-zinc-900/40">
              ...
              {loadingScraped && page === 1 && displayManhuas.length === 0 ? (
                <div className="py-20 flex flex-col items-center justify-center space-y-3">
                  ...
                  <p className="text-zinc-400 text-sm font-semibold">جاري التحميل...</p>
                </div>
                ...
                <div className="py-20 flex flex-col items-center justify-center text-center space-y-4 max-w-md mx-auto">
                  <div className="p-4 bg-red-950/40 border border-red-800/50 rounded-2xl text-center space-y-1">
                    <p className="text-red-400 font-bold text-base">حدث خطأ!</p>
                    <p className="text-zinc-400 text-xs">{scrapedError}</p>
                  </div>
                  <div className="flex gap-4">
                    <button
                      onClick={() => handleFetchAllSources(1, searchQuery)}
                      className="px-6 py-2.5 bg-red-500 hover:bg-red-600 text-white rounded-xl text-xs font-black transition-all flex items-center gap-2 shadow-lg cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="px-6 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-white rounded-xl text-xs font-black transition-all flex items-center gap-2 shadow-lg cursor-pointer"
                    >
                ...
                <div className="py-20 flex flex-col items-center justify-center text-center space-y-4 max-w-md mx-auto">
                  <p className="text-zinc-300 font-bold text-base">لا يوجد نتائج</p>
                  <p className="text-zinc-400 text-xs">
                    {searchQuery ? `لم نتمكن من العثور على نتائج للبحث عن "${searchQuery}"` : `لا توجد ${appMode === 'anime' ? 'أنميات' : 'مانهوات'} متاحة حالياً.`}
                  </p>
                  <button
                    onClick={() => handleFetchAllSources(1, searchQuery)}
                    className="px-6 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-white rounded-xl text-xs font-black transition-all flex items-center gap-2 shadow-lg cursor-pointer"
